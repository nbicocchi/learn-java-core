...
1. Create a normal class `AddressController.java`. 
...
1. Open `address-view.fxml` with *Scene Builder*.

2. Open the *Controller* group on the left side and select the `AddressController` as **controller class**.   
