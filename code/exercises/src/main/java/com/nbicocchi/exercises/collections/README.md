...
The sequence is generated by "reading" the previous number. \
The first number is "1" and the second number is "11", because there is one 1 in the previous number. "one 1" \
The third number is "21", obtained by reading the second number. "two 1" \
The fourth number is "1211", obtained by reading the third number. "one 2, one 1" \
The fifth number is "111221", obtained by reading the fourth number. "one 1, one 2, two 1" \
