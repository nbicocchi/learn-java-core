...
Array declaration and initialization in separate statements is another way to create an array in Java.
...
Array declaration with default values is a way to create an array in Java and initialize it with default values of the specified data type. 
