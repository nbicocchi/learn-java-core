...
public class QueueExample {
    ...
    public static void main(String[] args) {
        Queue<Integer> fifo = new LinkedList<>(List.of(5, 1, 2, 4, 3));
        Queue<Integer> fifoArray = new ArrayDeque<>(List.of(5, 1, 2, 4, 3));
        Queue<Integer> pqueue = new PriorityQueue<>(List.of(5, 1, 2, 4, 3));
...
## Manipulating Collections: java.util.Collections
