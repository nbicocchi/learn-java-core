...
We can also sort a Collection of Persons using a `Comparator<Person>`. A Comparator can be obtained by instantiating a class implementing `Comparator<Person>` (i.e., SortByAge).
