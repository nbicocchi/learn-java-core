...
Verbosity, in general, is bad because it takes a long time to write and maintain verbose code. Nevertheless, please keep in mind that extremely synthetic code is often hard to understand and to maintain as well. **Readability is key**.
