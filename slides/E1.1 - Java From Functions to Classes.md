...
**abstract interaction**_ between them. Simply put, when components of our system have dependencies, we don't want directly inject a component's dependency into another. Instead, we should use a level of abstraction between them.

**Dependency Inversion is the strategy of depending upon interfaces or abstract functions and classes rather then upon concrete functions and classes.**
