...
Is there a specific rule on how overriding `equals() & hashCode()` in sub classes considering super fields?

You can modify `equals() & hashCode()` method to use instanceof comparison rather than class equality, and then use it straightforwardly. Something like this:
