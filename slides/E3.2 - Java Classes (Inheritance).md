...
The polymorphism behaviour is linked to the fact that it is called the same method but once with zero parameters and the other with one and they do different things; nowadays, it's not considered a real polymorphism.
