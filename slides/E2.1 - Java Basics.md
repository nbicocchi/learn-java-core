...
| --------------------------- | ---------------------------------------------------------------------------------------------------------------- | ---------------------------------- |
| **Integral Literals**       | Consist of digit sequences. Subtypes:                                                                            |                                    |
| Decimal Integer             | Base 10, digits 0–9. Can be positive (+) or negative (-). No commas or non-digit characters allowed.             | `int d = 2022, +42, -68;`          |
| Octal Integer               | Base 8, digits 0–7. Always begin with `0`.                                                                       | `int o = 007, 0275;`               |
| Hexadecimal                 | Base 16, digits 0–9 and A–F (case-sensitive). A–F represent 10–15.                                               | `int e = 0xFF, 0x9A;`              |
| Binary Integer              | Base 2, digits 0 and 1. Prefix `0b` indicates binary.                                                            | `int b = 0b11011;`                 |
| **Floating-Point Literals** | Represent decimal fractions or exponential notation. Can be positive or negative (default positive).             |                                    |
...
| **String Literals**         | Enclosed in double quotes. Can include alphanumeric, special characters, blank spaces, etc.                      | `String s = "John", "2468", "\n";` |
| **Boolean Literals**        | Only two values: `true` or `false`. Case-insensitive. Can also be represented as 0 or 1.                         | `boolean b = true;`                |
| **Null Literals**           | Represent a null value, indicating no object. Used for uninitialized references. Dereferencing null is an error. | `Patient age = NULL;`              |
...
public class Location {
    ...
    public static void main(String[] args) {
        ...
        l.x++;
        l.y++; // Cannot assign a value to final variable 'y'
    }
}
```
